 ...
 */
public class GATANK_8 extends AdvancedRobot {
	
	float[] genes=new float[]{(float)0.7602396,(float)0.32490844,(float)0.08192551,(float)0.27706236,(float)0.7568086,(float)0.49767673,(float)0.20170373,(float)0.57690084,(float)0.16319221,(float)0.97694135};
