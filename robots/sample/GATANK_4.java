...
public class GATANK_4 extends AdvancedRobot {
	...
	float[] genes=new float[]{(float)0.7608667,(float)0.44168288,(float)0.8951147,(float)0.6694003,(float)0.76472664,(float)0.40738302,(float)0.7257435,(float)0.7838764,(float)0.57171786,(float)0.47250634};
