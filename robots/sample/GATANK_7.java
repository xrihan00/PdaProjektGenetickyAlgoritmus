...
public class GATANK_7 extends AdvancedRobot {
	...
	float[] genes=new float[]{(float)0.75997084,(float)0.1320051,(float)0.5905587,(float)0.68034613,(float)0.46770084,(float)0.67923117,(float)0.5485438,(float)0.20248276,(float)0.2738241,(float)0.76455635};
