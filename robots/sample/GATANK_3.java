...
public class GATANK_3 extends AdvancedRobot {
	...
	float[] genes=new float[]{(float)0.7607771,(float)0.7107151,(float)0.06465912,(float)0.47049487,(float)0.33502406,(float)0.13456786,(float)0.5080235,(float)0.32573706,(float)0.94192845,(float)0.40171134};
