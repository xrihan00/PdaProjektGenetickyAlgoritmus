 ...
 */
public class GATANK_1 extends AdvancedRobot {
	
	float[] genes=new float[]{(float)0.09122044,(float)0.8812888,(float)0.4146784,(float)0.06245339,(float)0.7735342,(float)0.82408214,(float)0.29260284,(float)0.25558126,(float)0.06761563,(float)0.90070087};
