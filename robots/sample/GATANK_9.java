...
public class GATANK_9 extends AdvancedRobot {
	...
	float[] genes=new float[]{(float)0.76015,(float)0.5939406,(float)0.2514699,(float)0.07815695,(float)0.327106,(float)0.22486156,(float)0.98398376,(float)0.11876148,(float)0.5334028,(float)0.90614635};
