...
public class GATANK_6 extends AdvancedRobot {
	...
	float[] genes=new float[]{(float)0.76050836,(float)0.5178118,(float)0.5732923,(float)0.87377864,(float)0.04591632,(float)0.3161223,(float)0.8548636,(float)0.951319,(float)0.05256033,(float)0.18932635};
