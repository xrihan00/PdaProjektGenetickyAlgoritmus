...
public class GATANK_2 extends AdvancedRobot {
	...
	float[] genes=new float[]{(float)0.75817925,(float)0.5126494,(float)0.9814466,(float)0.7022377,(float)0.8736493,(float)0.22292751,(float)0.1941446,(float)0.039695382,(float)0.6780365,(float)0.3486563};
