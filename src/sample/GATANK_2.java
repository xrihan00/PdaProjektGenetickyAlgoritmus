 ...
 */
public class GATANK_2 extends AdvancedRobot {
	
	float[] genes=new float[]{(float)0.85771084,(float)0.46629053,(float)0.63774914,(float)0.19514686,(float)0.05664289,(float)0.27819264,(float)0.8491927,(float)0.9105259,(float)0.5963104,(float)0.24704307};
