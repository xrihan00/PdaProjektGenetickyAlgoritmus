...
public class GATANK_5 extends AdvancedRobot {
	...
	float[] genes=new float[]{(float)0.8569046,(float)0.8875805,(float)0.16364872,(float)0.40499812,(float)0.18931967,(float)0.82285595,(float)0.88971305,(float)0.7872716,(float)0.92820597,(float)0.6098881};
