...
public class GATANK_1 extends AdvancedRobot {
	...
	float[] genes=new float[]{(float)0.85511297,(float)0.26822484,(float)0.55453664,(float)0.42688972,(float)0.5952681,(float)0.3665523,(float)0.5353138,(float)0.62448424,(float)0.33241844,(float)0.19398803};
