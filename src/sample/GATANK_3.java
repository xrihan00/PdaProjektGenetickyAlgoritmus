 ...
 */
public class GATANK_3 extends AdvancedRobot {
	
	float[] genes=new float[]{(float)0.8578004,(float)0.19725835,(float)0.46820474,(float)0.39405227,(float)0.48634547,(float)0.5510078,(float)0.06691265,(float)0.36866528,(float)0.22609973,(float)0.31783807};
