 ...
 */
public class GATANK_9 extends AdvancedRobot {
	
	float[] genes=new float[]{(float)0.85672545,(float)0.42564493,(float)0.5027375,(float)0.0071872473,(float)0.3299145,(float)0.2772256,(float)0.4542731,(float)0.8709929,(float)0.6686272,(float)0.46829808};
