 ...
 */
public class GATANK_6 extends AdvancedRobot {
	
	float[] genes=new float[]{(float)0.8570838,(float)0.3495161,(float)0.8245599,(float)0.80280894,(float)0.04872483,(float)0.36848634,(float)0.32515293,(float)0.70355034,(float)0.18778473,(float)0.7514781};
