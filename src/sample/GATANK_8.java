...
public class GATANK_8 extends AdvancedRobot {
	...
	float[] genes=new float[]{(float)0.8565463,(float)0.96370935,(float)0.8418263,(float)0.60937643,(float)0.47050935,(float)0.7315952,(float)0.01883316,(float)0.9547141,(float)0.4090485,(float)0.32670808};
