 ...
 */
public class GATANK_7 extends AdvancedRobot {
	
	float[] genes=new float[]{(float)0.85663587,(float)0.6946772,(float)0.6722819,(float)0.80828184,(float)0.90021193,(float)0.0044104457,(float)0.23655313,(float)0.41285348,(float)0.03883785,(float)0.39750308};
