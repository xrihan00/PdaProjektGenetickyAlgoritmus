 ...
 */
public class GATANK_4 extends AdvancedRobot {
	
	float[] genes=new float[]{(float)0.8574421,(float)0.2733872,(float)0.14638233,(float)0.59843063,(float)0.76753515,(float)0.45974708,(float)0.19603282,(float)0.53610784,(float)0.70694226,(float)0.034658074};
